...
import { User, LogOut, Sun, Moon, ChevronDown, Settings, Loader2 } from "lucide-react"
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    <button
                      ...
                      className="w-full h-[40px] flex items-center gap-3 px-3 py-2.5 text-sm text-destructive hover:bg-destructive/10 rounded-lg transition-colors cursor-pointer disabled:opacity-50"
                    >
                      {isLoggingOut ? (
